...
const Footer = () => {
  return (
    <footer className="bg-[hsl(250,30%,8%)] text-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-16 relative z-10">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            <a href="/" className="flex items-center gap-2 mb-6">
              ...
              <span className="text-xl font-bold">infetech</span>
            </a>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <a href="tel:+8898006802" className="text-white/70 hover:text-primary transition-colors text-sm">
                  + 88 ( 9800 ) 6802
                </a>
              </li>
              <li className="flex items-start gap-3">
                <Mail className="w-4 h-4 text-primary flex-shrink-0 mt-1" />
                <a href="mailto:needhelp@company.com" className="text-white/70 hover:text-primary transition-colors text-sm">
              ...
              <li className="flex items-start gap-3">
                ...
                <span className="text-white/70 text-sm">
                  88 Broklyn Golden Street<br/>New York, USA
                </span>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-white/10 pt-8 text-center">
          <p className="text-white/60 text-sm">
            &copy; Copyright 2024 by Infetech
          </p>
        </div>
      </div>
    </footer>
